    ...
    public class AabningstiderModel : PageModel
    {
        ...
        public void OnGet()
        {
            AdresseHtml = @"
                ...
                <p>4000 Roskilde</p>
                <p>tlf 12 34 56 78</p>
                <p><a href='https://www.google.com/maps/search/?api=1&query=Maglegårdsvej+2+4000+Roskilde' target='_blank'>Find vej</a></p>
            ";
            ...
            AabningstiderHtml = @"
                ...
                <table style='border-spacing: 0;'>
                    ...
                    <tr><td>Lørdag:</td><td style='padding-left: 10px;'>Lukket</td></tr>
                    <tr><td>Søndag:</td><td style='padding-left: 10px;'>Lukket</td></tr>
                </table>
            ";
        }
    }
